...
%%Below is my implementation of imdct (SLOW!!!!)

%function frameT = imdct4(frameF)
%    N2 = size(frameF,1); N = 2*N2; n0 = (N/2 + 1)/2;
%    frameT = zeros(N,1);
%
%    for n=0:N-1
%        cosines = cos(2*pi/N* (n+n0) * ((0:N/2-1)+0.5) );
%        frameT(n+1) = 2/N* cosines * frameF;
%    end
%
%end